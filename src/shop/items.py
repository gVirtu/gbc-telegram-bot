...
SHOP_CATEGORIES: list[ShopCategory] = [
    ShopCategory(
        ...
        items=[
            ...
            ShopItem("name_tag_red",     "shop.items.name_tag_red",     25000, {"name_tag_color": "#FF8888"}),
            ShopItem("name_tag_green",   "shop.items.name_tag_green",   25000, {"name_tag_color": "#88FF88"}),
            ShopItem("name_tag_blue",    "shop.items.name_tag_blue",    25000, {"name_tag_color": "#8888FF"}),
            ShopItem("name_tag_yellow",  "shop.items.name_tag_yellow",  25000, {"name_tag_color": "#FFFF88"}),
            ShopItem("name_tag_magenta", "shop.items.name_tag_magenta", 25000, {"name_tag_color": "#FF88FF"}),
            ShopItem("name_tag_cyan",    "shop.items.name_tag_cyan",    25000, {"name_tag_color": "#88FFFF"}),
        ],
    ),
    ShopCategory(
        id="reactions",
