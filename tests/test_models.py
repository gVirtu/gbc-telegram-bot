...
class TestGameButton:
    ...
    def test_button_emojis(self):
        ...
        assert GameButton.START.emoji == "▶️"
        assert GameButton.SELECT.emoji == "🔘"
    
    def test_button_display_names(self):
        """Test display name mapping."""
        assert GameButton.UP.display_name == "Up"
        assert GameButton.DOWN.display_name == "Down"
        assert GameButton.LEFT.display_name == "Left"
        assert GameButton.RIGHT.display_name == "Right"
